...
void NotificationsLomiriPostal::processIncomingMsgBunch(uint32_t accID)
{
    ...
    // obtained via a DBus call to com.ubuntu.Postal.
...
void NotificationsLomiriPostal::sendNotification(QString summary, QString body, QString tag, QString icon)
{
    ...
    QDBusMessage message;
    message = QDBusMessage::createMethodCall("com.ubuntu.Postal", "/com/ubuntu/Postal/deltatouch_2elotharketterer", "com.ubuntu.Postal", "Post");
    QString appid("deltatouch.lotharketterer_deltatouch");
...
void NotificationsLomiriPostal::removeNotification(QString tag)
{
    ...
    QDBusMessage message;
    message = QDBusMessage::createMethodCall("com.ubuntu.Postal", "/com/ubuntu/Postal/deltatouch_2elotharketterer", "com.ubuntu.Postal", "ClearPersistent");
    QString appid("deltatouch.lotharketterer_deltatouch");
    message << appid << tag;
    m_bus->send(message);
//    QDBusPendingCall pcall = m_bus->asyncCall(message);
...
void NotificationsLomiriPostal::removeActiveNotificationsOfChat(uint32_t accID, int chatID)
{
    ...
    // Query com.ubuntu.Postal for the tags of the currently active notifications
    QDBusMessage message;
    message = QDBusMessage::createMethodCall("com.ubuntu.Postal", "/com/ubuntu/Postal/deltatouch_2elotharketterer", "com.ubuntu.Postal", "ListPersistent");
    QString appid("deltatouch.lotharketterer_deltatouch");
    message << appid;
