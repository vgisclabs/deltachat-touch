...
Page {
    ...
    header: PageHeader {
       ...
       //   //      text: i18n.tr('Help')
       //   //      onTriggered: {
       //   //          layout.addPageToCurrentColumn(qrShowScanPage, Qt.resolvedUrl('Help.qml'))
       //   //      }
       //   //  },
       //     Action {
       //         iconName: 'info'
       ...
       //         onTriggered: {
       //                     layout.addPageToCurrentColumn(qrShowScanPage, Qt.resolvedUrl('About.qml'))
       //         }
       //     }
       // ]
    }
    ...
    Image {
        id: qrImage
        width: (parent.width < parent.height - qrHeader.height ? parent.width : parent.height - qrHeader.height - qrSections.height) - units.gu(2)
        height: width
        anchors {
    ...
    Rectangle {
        ...
        Label {
            id: pasteLabel
            width: qrReadRect.width - units.gu (6)
            anchors {
                top: qrReadRect.top
                topMargin: units.gu(3)
                left: qrReadRect.left
